...
public class RTree implements Serializable {
    ...
    private void checkOverflow(RTreeNode node) {
        if (node.overflow()) {
            // Uncomment to select the relevant split method
     ...
     */
    public static class NearestRoadPriorityQueueEntry implements Comparable<NearestRoadPriorityQueueEntry>, Serializable {
        @Serial
        private static final long serialVersionUID = 1904335497921633398L;

        private final boolean isRTreeNode;
        private final RTreeNode rTreeNode;
        private final Way originalWay;
        private final Way segment;
